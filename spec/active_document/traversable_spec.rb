...
describe ActiveDocument::Traversable do
  ...
  describe '#discriminator_key' do
    ...
    context 'when the discriminator key is not set on a class' do
      it 'sets the global discriminator key to _type' do
        expect(ActiveDocument.discriminator_key).to eq('_type')
      end
    ...
    context 'when the discriminator key is changed at the global level' do
      ...
      it 'sets the correct value globally' do
        expect(ActiveDocument.discriminator_key).to eq('hello')
      end
    ...
    context 'when the discriminator key is changed in the child' do
      ...
      it 'raises an error' do
        expect do
          set_discriminator_key
        end.to raise_error(ActiveDocument::Errors::InvalidDiscriminatorKeyTarget)
      end
    ...
    context "when the discriminator key conflicts with active_document's internals" do
      ...
      %i[_association invalid].each do |meth|
        context "when the field is named #{meth}" do
          ...
          it 'raises an error' do
            ...
            end.to raise_error(ActiveDocument::Errors::InvalidField)
          end
        end
      end
    end
    ...
    context "when the global discriminator key conflicts with active_document's internals" do
      ...
      %i[_association invalid].each do |meth|
        context "when the field is named #{meth}" do
          ...
          it 'raises an error' do
            expect do
              ActiveDocument.discriminator_key = meth
            end.to raise_error(ActiveDocument::Errors::InvalidField)
          end
        end
      end
