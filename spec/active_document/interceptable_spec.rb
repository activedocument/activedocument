...
describe ActiveDocument::Interceptable do
  ...
  class TestClass
    include ActiveDocument::Interceptable
  ...
  context 'when cascading callbacks' do
    ...
    context 'when attempting to cascade on a referenced relation' do
      ...
      it 'raises an error' do
        ...
        end.to raise_error(ActiveDocument::Errors::InvalidRelationOption)
      end
    end
  ...
  context 'when around callbacks for embedded are disabled' do
    ...
    context 'when around callback is defined' do
      ...
      it 'logs a warning' do
        expect(ActiveDocument.logger).to receive(:warn).with(/Around callbacks are disabled for embedded documents/).twice.and_call_original
        expect(ActiveDocument.logger).to receive(:warn).with(/To enable around callbacks for embedded documents/).twice.and_call_original
