...
describe ActiveDocument::Association::Referenced::HasMany::Proxy do
  ...
  describe '#create' do
    ...
    context 'when the association is not polymorphic' do
      context 'when the parent is a new record' do
        ...
        it 'raises an unsaved document error' do
          expect { post }.to raise_error(ActiveDocument::Errors::UnsavedDocument)
        end
      end
    ...
    context 'when the association is polymorphic' do
      context 'when the parent is a new record' do
        ...
        it 'raises an unsaved document error' do
          expect { rating }.to raise_error(ActiveDocument::Errors::UnsavedDocument)
        end
      end
        ...
        context 'when validation fails' do
          it 'raises an error' do
            expect { person.posts.create!(title: '$$$') }
              .to raise_error(ActiveDocument::Errors::Validations)
          end
        end
      end
    end
  ...
  describe '#criteria' do
    ...
    context 'when the association is not polymorphic' do
      ...
      it 'does not include the type in the criteria' do
        expect(criteria.selector_render).to eq({ 'person_id' => base.id })
      end
    end
  end
      ...
      context 'when the document is found' do
        context 'when no dependent option is set' do
          context 'when we are assigning attributes' do
            ...
            before do
              ActiveDocument::Threaded.begin_execution(:assign)
            end

            after do
              ActiveDocument::Threaded.exit_execution(:assign)
            end
        ...
        context 'when the id matches but is not scoped to the association' do
          ...
          it 'raises an error' do
            expect { person.posts.find(post.id) }
              .to raise_error(ActiveDocument::Errors::DocumentNotFound,
      ...
      context 'when providing an id' do
        ...
        context 'when the id does not match' do
          context 'when config set to raise error' do
            ...
            let(:expected_error) { ActiveDocument::Errors::DocumentNotFound }
  ...
  describe '#initialize' do
    context 'when an illegal mixed association exists' do
      ...
      it 'raises an error' do
        expect { post.videos }
          .to raise_error(ActiveDocument::Errors::MixedRelations)
      end
    end
  ...
  describe '#scoped' do
    ...
    it 'returns with an empty selector' do
      expect(scoped.selector_render).to eq({ 'person_id' => person.id })
    end
  end
