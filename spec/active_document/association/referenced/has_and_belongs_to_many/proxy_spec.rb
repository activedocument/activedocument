...
describe ActiveDocument::Association::Referenced::HasAndBelongsToMany::Proxy do
      ...
      context "when the relation is not polymorphic" do
        ...
        context "when the parent is a new record" do
          ...
          it "raises an unsaved document error" do
            ...
            }.to raise_error(ActiveDocument::Errors::UnsavedDocument)
          end
        end
  ...
  describe "#respond_to?" do
    ...
    ActiveDocument::Association::Referenced::HasAndBelongsToMany::Proxy.public_instance_methods.sort.each do |method|
