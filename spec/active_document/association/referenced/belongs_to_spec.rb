...
describe ActiveDocument::Association::Referenced::BelongsTo do
  ...
  before do
    ...
    class BelongingObject; include ActiveDocument::Document; end
  end
  ...
  describe '#setup!' do
    ...
    context 'counter cache callbacks' do
      ...
      context 'when the :counter_cache option is true' do
        ...
        it 'sets up counter cache callbacks' do
          expect(ActiveDocument::Association::Referenced::CounterCache).to receive(:define_callbacks!).with(association)
          association.setup!
        end
      end
      ...
      context 'when the dependent option is provided' do
        ...
        context 'when the dependent option is :delete_all' do
          ...
          it 'sets up the dependency' do
            expect(ActiveDocument::Association::Depending).to receive(:define_dependency!)
            association.setup!
          end
        end
    ...
    context 'touchable' do
      ...
      context 'when the :touch option is true' do
        ...
        it 'sets up touch' do
          expect(ActiveDocument::Touchable).to receive(:define_touchable!).with(association)
          association.setup!
        end
      end
  ...
  describe '#primary_key' do
    ...
    context 'when the :primary_key option is not specified' do
      ...
      it 'returns the default primary key' do
        expect(association.primary_key).to eq(ActiveDocument::Association::Relatable::PRIMARY_KEY_DEFAULT)
      end
    end
  end
