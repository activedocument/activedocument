...
describe ActiveDocument::Association::Referenced::HasMany do
  ...
  describe '#criteria' do
    ...
    it 'returns a criteria object' do
      expect(association.criteria(OwnerObject.new)).to be_a(ActiveDocument::Criteria)
    end
  end
  ...
  describe '#path' do
    ...
    it 'returns an instance of ActiveDocument::Atomic::Paths::Root' do
      expect(association.path(double(_parent: true))).to be_a(ActiveDocument::Atomic::Paths::Root)
    end
  end
