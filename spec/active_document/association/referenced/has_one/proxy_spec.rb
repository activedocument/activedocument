...
describe ActiveDocument::Association::Referenced::HasOne::Proxy do
  ...
  describe '#=' do
    ...
    context 'when the relationship is an illegal embedded reference' do
      ...
      it 'raises a mixed relation error' do
        expect do
          game.video = video
        end.to raise_error(ActiveDocument::Errors::MixedRelations)
      end
    end
        ...
        context 'when reloading the parent' do
          ...
          context 'when setting a new document on the relation' do
            ...
            it 'detaches the previous relation' do
              expect do
                game.reload
              end.to raise_error(ActiveDocument::Errors::DocumentNotFound, /Document\(s\) not found for class Game with id\(s\)/)
            end
          end
        end
      end
  ...
  describe '#respond_to?' do
    ...
    ActiveDocument::Document.public_instance_methods(true).each do |method|
  ...
  context 'when the document is not persisted and the association is invalid' do
    ...
    before do
      ...
      class HomChild; include ActiveDocument::Document; end
