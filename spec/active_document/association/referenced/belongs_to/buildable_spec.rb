...
describe ActiveDocument::Association::Referenced::Association do
  ...
  describe '#build' do
    ...
    let(:association) do
      ActiveDocument::Association::Referenced::Association.new(Post, :person, :belongs_to_one, options)
    end
    ...
    context 'when provided an id' do
      ...
      context 'when the object is an object id' do
        ...
        before do
          expect_any_instance_of(ActiveDocument::Criteria).to receive(:where).with(association.primary_key => object).and_call_original
        end
    ...
    context 'when provided a object' do
      ...
      before do
        expect_any_instance_of(ActiveDocument::Criteria).to_not receive(:where)
      end
