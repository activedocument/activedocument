...
describe ActiveDocument::Association::Options do
  ...
  [
    ...
    context "when the association type is #{association_class}" do
      ...
      let(:class_left) do
        class ClassLeft; include ActiveDocument::Document; end
        ClassLeft
      end

      let(:class_right) do
        class ClassRight; include ActiveDocument::Document; end
        ClassRight
      end
      ...
      describe 'the :as option' do
        ...
        context 'when the option is not supported by the association type', if: association_class::VALID_OPTIONS.exclude?(:as) do
          ...
          context 'when the option is provided' do
            ...
            it 'raises a ActiveDocument::Errors::InvalidRelationOption error' do
              expect do
                association
