...
describe ActiveDocument::Association::Macros do
  ...
  describe '.embedded_in' do
    ...
    context 'when the relation name is invalid' do
      ...
      it 'raises an InvalidRelation exception' do
        expect do
          relation
        end.to raise_exception(ActiveDocument::Errors::InvalidRelation)
      end
    end
    ...
    context 'when defining the relation' do
      ...
      it 'adds an associated validation' do
        expect(klass._validators[:addresses].first).to be_a(
          ActiveDocument::Validatable::AssociatedValidator
        )
      end
  ...
  describe '.belongs_to' do
    ...
    let(:default_require) { ActiveDocument.belongs_to_required_by_default }
  ...
  describe '#relations' do
    ...
    it 'has keys that are the relation name' do
      expect(klass.allocate.relations['name']).to be_a(ActiveDocument::Association::Embedded::EmbedsOne)
    end
    ...
    it 'has values that are association' do
      ...
      ).to be_a(ActiveDocument::Association::Embedded::EmbedsOne)
    end
  end
