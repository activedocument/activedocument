...
describe ActiveDocument::Association::Embedded::EmbedsMany do
  ...
  context 'when projecting with #only' do
    ...
    it 'populates specified fields only' do
      ...
      expect do
        legislator.b
      end.to raise_error(ActiveDocument::Errors::AttributeNotLoaded, /Attempted to access attribute 'b' on EmmLegislator which was not loaded/)
    ...
    context 'when excluding the relation' do
      ...
      it 'raises AttributeNotLoaded' do
        ...
        end.to raise_error(ActiveDocument::Errors::AttributeNotLoaded, /Attempted to access attribute 'legislators' on EmmCongress which was not loaded/)
      end
    end
  end
end
