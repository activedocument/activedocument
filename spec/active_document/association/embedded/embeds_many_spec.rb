...
describe ActiveDocument::Association::Embedded::EmbedsMany do
  ...
  describe '#relation' do
    ...
    it 'returns ActiveDocument::Association::Embedded::EmbedsMany::Proxy' do
      expect(association.relation).to be(ActiveDocument::Association::Embedded::EmbedsMany::Proxy)
    end
  end
  ...
  describe '#nested_builder' do
    ...
    it 'returns an instance of Association::Nested::One' do
      expect(association.nested_builder({}, {})).to be_a(ActiveDocument::Association::Nested::Many)
    end
  end
  ...
  describe '#path' do
    ...
    it 'returns an instance of ActiveDocument::Atomic::Paths::Root' do
      expect(association.path(double(_parent: true))).to be_a(ActiveDocument::Atomic::Paths::Embedded::Many)
    end
  end
  ...
  context "when the document and embedded document's klass is in a submodule" do
    ...
    it 'has the correct inverses' do
      ...
      expect(inverse_assoc).to be_a(ActiveDocument::Association::Embedded::EmbeddedIn)
