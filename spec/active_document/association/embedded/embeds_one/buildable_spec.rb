...
describe ActiveDocument::Association::Embedded::EmbedsOne::Buildable do
  ...
  describe '#build' do
    ...
    let(:association) do
      ActiveDocument::Association::Embedded::EmbedsOne.new(Person, :name, options)
    end
    ...
    context 'when a type is in the object' do
      ...
      let(:association) do
        ActiveDocument::Association::Embedded::EmbedsOne.new(Person, :writer, options)
      end
