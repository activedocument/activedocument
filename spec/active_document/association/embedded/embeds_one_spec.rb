...
describe ActiveDocument::Association::Embedded::EmbedsOne do
  ...
  describe '#relation' do
    ...
    it 'returns ActiveDocument::Association::Embedded::EmbedsOne::Proxy' do
      expect(association.relation).to be(ActiveDocument::Association::Embedded::EmbedsOne::Proxy)
    end
  end
  ...
  describe '#path' do
    ...
    it 'returns an instance of ActiveDocument::Atomic::Paths::Root' do
      expect(association.path(double(_parent: true))).to be_a(ActiveDocument::Atomic::Paths::Embedded::One)
    end
  end
  ...
  describe '#create_relation' do
    ...
    it 'returns an the target (EmbeddedObject)' do
      expect(ActiveDocument::Association::Embedded::EmbedsOne::Proxy).to receive(:new).and_call_original
