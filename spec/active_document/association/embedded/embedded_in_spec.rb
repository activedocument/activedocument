...
describe ActiveDocument::Association::Embedded::EmbeddedIn do

  before do
    class Container; include ActiveDocument::Document; end
    class EmbeddedObject; include ActiveDocument::Document; end
  end
  ...
  describe '#VALID_OPTIONS' do
    ...
    it 'returns the SHARED options with the ASSOCIATION_OPTIONS' do
      expect(association.class::VALID_OPTIONS).to match_array(ActiveDocument::Association::Relatable::SHARED_OPTIONS +
  ...
  describe '#relation' do
    ...
    it 'returns ActiveDocument::Association::Embedded::EmbeddedIn::Proxy' do
      expect(association.relation).to be(ActiveDocument::Association::Embedded::EmbeddedIn::Proxy)
    end
  end
  ...
  describe '#relation_class_name' do
    ...
    context 'when the :class_name option is specified' do
      ...
      let(:options) do
        ...
        # to prevent ActiveDocument from attempting to load the bogus class.
  ...
  describe '#nested_builder' do
    ...
    it 'returns an instance of Association::Nested::One' do
      expect(association.nested_builder({}, {})).to be_a(ActiveDocument::Association::Nested::One)
    end
  end
  ...
  describe '#cascading_callbacks?' do
    ...
    context 'when cascade_callbacks is specified in the options' do
      ...
      it 'raises a ActiveDocument::Errors::InvalidRelationOption exception' do
        expect do
          association.cascading_callbacks?
        end.to raise_exception(ActiveDocument::Errors::InvalidRelationOption)
      end
    end
  ...
  describe '#path' do
    ...
    it 'returns an instance of ActiveDocument::Atomic::Paths::Root' do
      expect(association.path({})).to be_a(ActiveDocument::Atomic::Paths::Root)
    end
  end
  ...
  describe '#create_relation' do
    ...
    it 'returns an instance of ActiveDocument::Association::Embedded::EmbeddedIn::Proxy' do
      expect(ActiveDocument::Association::Embedded::EmbeddedIn::Proxy).to receive(:new).and_call_original
