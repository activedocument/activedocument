...
describe ActiveDocument::Association::Embedded::EmbedsMany::Proxy do
  ...
  describe "#respond_to?" do
    ...
    ActiveDocument::Association::Embedded::EmbedsMany::Proxy.public_instance_methods.each do |method|
  ...
  describe "#unscoped" do
    ...
    it "returns the relation criteria" do
      expect(unscoped).to be_a(ActiveDocument::Criteria)
    end
