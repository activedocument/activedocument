...
describe ActiveDocument::Association::Embedded::EmbedsMany::Buildable do
  ...
  describe '#build' do
    ...
    let(:association) do
      ActiveDocument::Association::Embedded::EmbedsMany.new(Person, :addresses, options)
    end
    ...
    context 'when a type is in the object' do
      ...
      let(:association) do
        ActiveDocument::Association::Embedded::EmbedsMany.new(Person, :shapes)
      end
