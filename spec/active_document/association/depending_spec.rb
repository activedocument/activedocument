...
describe ActiveDocument::Association::Depending do
      ...
      context 'when the model is a subclass' do
        ...
        context 'when transitive dependents are defined' do
          ...
          it 'facilitates proper destroying of the object' do
            ...
            expect { DependentReportCard.find(r.id) }.to raise_error(ActiveDocument::Errors::DocumentNotFound, /Document\(s\) not found for class DependentReportCard with id\(s\)/)
          end
        ...
        context 'when a superclass is reopened and a new dependent is added' do
          ...
          it 'causes the destruction of the inherited destroy dependent' do
            ...
            end.to raise_error(ActiveDocument::Errors::DocumentNotFound, /Document\(s\) not found for class DependentOwnedOne with id\(s\)/)
          end
        end
        ...
        context 'when a separate subclass overrides the destroy dependent' do
          ...
          it 'causes the destruction of the destroy dependent' do
            ...
            expect { Dep.find(dep.id) }.to raise_error(ActiveDocument::Errors::DocumentNotFound, /Document\(s\) not found for class Dep with id\(s\)/)
          end
        end
      end
    end
  ...
  describe '.define_dependency!' do
    ...
    let(:klass) do
      Class.new.tap { |c| c.send(:include, ActiveDocument::Document) }
    end
      ...
      shared_examples 'destroys dependents if parent is destroyed but does not if parent is deleted' do
        describe '#destroy' do
          ...
          it 'deletes the associated documents' do
            ...
            end.to raise_error(ActiveDocument::Errors::DocumentNotFound, /Document\(s\) not found for class #{child.class} with id\(s\)/)
          end
        end
      ...
      shared_examples 'raises an error with #destroy and deletes the parent with #delete' do
        describe '#destroy' do
          it 'raises DeleteRestriction error' do
            expect { person.destroy }.to raise_error(ActiveDocument::Errors::DeleteRestriction)
          end
        end
      ...
      context 'when cascading a has one' do
        ...
        context 'when the relation exists' do
          ...
          it 'persists the deletion' do
            expect do
              home.reload
            end.to raise_error(ActiveDocument::Errors::DocumentNotFound, /Document\(s\) not found for class Home with id\(s\)/)
          end
        end
    ...
    context 'when the strategy is :restrict_with_exception' do
      ...
      context 'when there are related objects' do
        ...
        it 'raises an exception and leaves the related one intact' do
          expect { person.destroy }.to raise_exception(ActiveDocument::Errors::DeleteRestriction)
        end
      end
