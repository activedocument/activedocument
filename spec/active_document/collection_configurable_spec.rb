...
describe ActiveDocument::CollectionConfigurable do
  ...
  after(:all) do
    ActiveDocument.deregister_model(CollectionConfigurableValidOptions)
    Object.send(:remove_const, :CollectionConfigurableValidOptions)
    ActiveDocument.deregister_model(CollectionConfigurableUnknownOptions)
    Object.send(:remove_const, :CollectionConfigurableUnknownOptions)
    ActiveDocument.deregister_model(CollectionConfigurableInvalidOptions)
  ...
  context 'when collection does not exist' do
    ...
    context 'with an unknown collection options' do
      ...
      it 'raises an error' do
        expect do
          subject.create_collection
        end.to raise_error(ActiveDocument::Errors::CreateCollectionFailure)
      end
    end
