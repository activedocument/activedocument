  ...
  describe '#context' do
    ...
    context 'when the model is embedded' do
      ...
      it 'returns the embedded context' do
        expect(criteria.context).to be_a(ActiveDocument::Contextual::Memory)
      end
    end
    ...
    context 'when the model is not embedded' do
      ...
      it 'returns the mongo context' do
        expect(criteria.context).to be_a(ActiveDocument::Contextual::Mongo)
      end
    end
  end
    ...
    context 'when provided a string' do
      ...
      context 'when the criteria is embedded' do
        ...
        it 'raises an error' do
          ...
          end.to raise_error(ActiveDocument::Errors::UnsupportedJavascript)
        end
      end
    ...
    context 'when provided criterion' do
      ...
      context 'when querying on a big decimal' do
        ...
        context 'when map_big_decimal_to_decimal128 was false and is now true' do
          ...
          let!(:band) do
            ActiveDocument.map_big_decimal_to_decimal128 = false
            Band.create!(name: 'Boards of Canada', sales: sales)
          end

          it 'cannot find values when querying using a BigDecimal value' do
            ActiveDocument.map_big_decimal_to_decimal128 = true
    ...
    context 'with allowed methods' do
      ...
      context 'when using aggregation methods' do
        ...
        it 'applies aggregation methods' do
          expect { criteria }.to_not raise_error
        end
      end
    end
    ...
    context 'security validation' do
      ...
      it 'allows all whitelisted methods' do
        ...
        allowed_sample.each do |method, args|
          ...
          expect { described_class.from_hash(hash) }.to_not raise_error
        end
      end
    end
  end
