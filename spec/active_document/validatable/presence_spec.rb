...
describe ActiveDocument::Validatable::PresenceValidator do
        ...
        context 'when the parent is valid' do
          ...
          context 'when saving the parent' do
            ...
            it 'does not save the association target' do
              ...
              expect { child.reload }.to raise_error(ActiveDocument::Errors::DocumentNotFound, /Document\(s\) not found for class HomAccreditation with id\(s\)/)
            end
          end
        end
      end
