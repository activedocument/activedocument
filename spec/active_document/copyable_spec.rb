...
describe ActiveDocument::Copyable do
      ...
      context 'when a document has fields from a legacy schema' do
        ...
        shared_examples 'behaves as expected' do
          ...
          it 'calls constructor with explicitly declared attributes only' do
            expect(ActiveDocument::Factory).to receive(:build).with(cls, { 'name' => 'test' }).and_call_original
            cloned
          end
        end
        ...
        context 'without Attributes::Dynamic' do
          ...
          before do
            expect(cls).to_not include(ActiveDocument::Attributes::Dynamic)
          end
        ...
        context 'with Attributes::Dynamic' do
          ...
          before do
            expect(cls).to include(ActiveDocument::Attributes::Dynamic)
          end
