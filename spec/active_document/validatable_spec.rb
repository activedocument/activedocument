...
describe ActiveDocument::Validatable do
  ...
  describe '#read_attribute_for_validation' do
    ...
    context 'when reading a relation' do
      ...
      let(:documents) do
        ActiveDocument::Association::Referenced::HasMany::Enumerable.new([address])
      end
  ...
  describe '.validates_uniqueness_of' do
    ...
    context 'when adding via the traditional macro' do
      ...
      it 'adds the validator' do
        expect(klass.validators.first).to be_a(
          ActiveDocument::Validatable::UniquenessValidator
        )
      end
    end
  ...
  describe '.validates_presence_of' do
    ...
    context 'when adding via the traditional macro' do
      ...
      it 'adds the validator' do
        expect(klass.validators.first).to be_a(
          ActiveDocument::Validatable::PresenceValidator
        )
      end
    end
