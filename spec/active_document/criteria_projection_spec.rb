...
describe ActiveDocument::Criteria do
  ...
  describe '#only' do
    ...
    context 'when not using inheritance' do
      ...
      context 'when passing splat args' do
        ...
        it 'limits the returned fields' do
          expect do
            criteria.first.name
          end.to raise_error(ActiveDocument::Errors::AttributeNotLoaded, /Attempted to access attribute 'name' on Band which was not loaded/)
        end
      ...
      context 'when passing an array' do
        ...
        it 'excludes the non included fields' do
          ...
          end.to raise_error(ActiveDocument::Errors::AttributeNotLoaded, /Attempted to access attribute 'active' on Band which was not loaded/)
        end
    ...
    context 'when the field is localized' do
      ...
      context 'when entire field is excluded' do
        ...
        it 'raises an ActiveDocument::Errors::AttributeNotLoaded when attempting to access the field' do
          expect { dictionary.description }.to raise_error ActiveDocument::Errors::AttributeNotLoaded
        end
      end
    ...
    context 'when excluding id fields' do
      ...
      shared_examples 'unprojects id' do
        ...
        it 'does not return id' do
          expect do
            instance.id
          end.to raise_error(ActiveDocument::Errors::AttributeNotLoaded, /Attempted to access attribute 'id' on Shirt which was not loaded/)
        end
      end
