...
describe ActiveDocument::Findable do
      ...
      context 'when the document is not found' do
        ...
        context 'when raising a not found error' do
          ...
          it 'raises an error' do
            ...
            end.to raise_error(ActiveDocument::Errors::DocumentNotFound, /Document not found for class Message with attributes/)
          end
        end
    ...
    context 'when the document is not found' do
      ...
      context 'when raising a not found error' do
        ...
        it 'raises an error' do
          ...
          end.to raise_error(ActiveDocument::Errors::DocumentNotFound, /Document not found for class Person with attributes/)
        end
      end
  ...
  ActiveDocument::Criteria::Queryable::Selectable.forwardables.each do |method|
