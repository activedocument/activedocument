  ...
  describe '#field' do
    ...
    context 'when the options are not valid' do
      ...
      it 'raises an error' do
        ...
        end.to raise_error(ActiveDocument::Errors::InvalidFieldOption)
      end
    end
  end
      ...
      %i[_association invalid].each do |meth|
        context "when the field is named #{meth}" do
          ...
          it 'raises an error' do
            expect do
              Person.field(meth)
            end.to raise_error(ActiveDocument::Errors::InvalidField, /Defining a field named '#{meth}' is not allowed/)
          end
        end
      end
    end
    ...
    context 'when as is specified' do
      ...
      context 'when defining a criteria' do
        ...
        it 'properly serializes the aliased field' do
          expect(criteria.selector_render).to eq({ 'aliased' => true })
        end
      end
    end
