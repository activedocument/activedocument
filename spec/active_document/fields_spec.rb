...
describe ActiveDocument::Fields do
  ...
  describe "#field" do
    ...
    before(:all) do
      ActiveDocument::Fields.option :custom do |model, field, value|
      end
    end
    ...
    context "when the options are not valid" do
      ...
      it "raises an error" do
        ...
        }.to raise_error(ActiveDocument::Errors::InvalidFieldOption)
      end
    end
  end
  ...
  describe ".field" do
      ...
      [:_association, :invalid].each do |meth|
        context "when the field is named #{meth}" do
          ...
          it "raises an error" do
            expect {
              Person.field(meth)
            }.to raise_error(ActiveDocument::Errors::InvalidField, /Defining a field named '#{meth}' is not allowed/)
          end
        end
      end
    end
    ...
    context "when field already exist and validate_duplicate is enable" do
      context 'when exception is enabled' do
        ...
        it "raises an error" do
          expect {
            Person.field(:title)
          }.to raise_error(ActiveDocument::Errors::InvalidField)
        end
      end
    ...
    context "custom options" do
      ...
      before do
        ActiveDocument::Fields.option :option, &handler
      end
  ...
  context "when a field is defined as a big decimal" do
    ...
    context 'when ActiveDocument.map_big_decimal_to_decimal128 is false' do
    ...
    context 'when ActiveDocument.map_big_decimal_to_decimal128 is true' do
