...
describe ActiveDocument::Criteria::Queryable::Selectable do
  ...
  shared_examples_for 'ands the arguments' do
    ...
    context 'when the field is not aliased' do
      ...
      it 'combines the conditions with $and' do
        expect(selection.selector_smash).to eq({
          'first' => { operator => [1, 2] },
    ...
    context 'when operator value is a Range' do
      ...
      context 'when there is no existing condition' do
        ...
        it 'expands range to array' do
          expect(selection.selector_smash).to eq({ 'foo' => { operator => [2, 3, 4] } })
        end
      end
  ...
  #       expect(selection.selector_smash).to eq({ 'first' => { operator => [2] } })
  #     end
  #
  #     it_behaves_like 'returns a cloned query'
  #   end
  ...
  #
  #     it 'intersects the conditions' do
  #       expect(selection.selector_smash).to eq({ '_id' => { operator => [2] } })
  #     end
  #
  #     it_behaves_like 'returns a cloned query'
  #   end
  ...
  #
  #     it 'intersects the conditions' do
  #       expect(selection.selector_smash).to eq({ 'field' => { operator => [2] } })
  #     end
  #
  #     it_behaves_like 'returns a cloned query'
  #   end
  ...
  #
  #       it 'expands range to array' do
  #         expect(selection.selector_smash).to eq({ 'foo' => { operator => [2, 3] } })
  #       end
  #     end
  #
  #     context 'when existing condition has Range value' do
  ...
  #       expect(selection.selector_smash).to eq({ 'first' => { operator => [1, 2, 3, 4] } })
  #     end
  #
  #     it_behaves_like 'returns a cloned query'
  #   end
  ...
  #
  #     it 'unions the conditions' do
  #       expect(selection.selector_smash).to eq({ '_id' => { operator => [1, 2, 3, 4] } })
  #     end
  #
  #     it_behaves_like 'returns a cloned query'
  #   end
  ...
  #
  #     it 'intersects the conditions' do
  #       expect(selection.selector_smash).to eq({ 'field' => { operator => [1, 2, 3] } })
  #     end
  #
  #     it_behaves_like 'returns a cloned query'
  #   end
  ...
  #
  #       it 'expands range to array' do
  #         expect(selection.selector_smash).to eq({ 'foo' => { operator => [1, 2, 3, 4] } })
  #       end
  #     end
  #
  #     context 'when existing condition has Range value' do
  ...
  #       expect(selection.selector_smash).to eq({ 'first' => { operator => [3, 4] } })
  #     end
  #
  #     it_behaves_like 'returns a cloned query'
  #   end
  ...
  #
  #     it 'overwrites the first condition' do
  #       expect(selection.selector_smash).to eq({ '_id' => { operator => [3, 4] } })
  #     end
  #
  #     it_behaves_like 'returns a cloned query'
  #   end
  ...
  #
  #     it 'intersects the conditions' do
  #       expect(selection.selector_smash).to eq({ 'field' => { operator => [2, 3] } })
  #     end
  #
  #     it_behaves_like 'returns a cloned query'
  #   end
  ...
  describe '#all' do
    ...
    context 'when given an argument' do
      ...
      it { expect { selection.selector_smash }.to raise_error(ArgumentError) }
    end
  end
  ...
  describe '#contains_all' do
    ...
    context 'when provided no criterion' do
      ...
      it { expect { selection.selector_smash }.to raise_error(ActiveDocument::Errors::CriteriaArgumentRequired) }
    end
      ...
      context 'when no serializers are provided' do
        ...
        context 'when providing an array' do
          ...
          it 'adds the $all selector' do
            expect(selection.selector_smash).to eq({ 'field' => { '$all' => [1, 2] } })
          end
        ...
        context 'when providing a single value' do
          ...
          it 'adds the $all selector with wrapped value' do
            expect(selection.selector_smash).to eq({ 'field' => { '$all' => [1] } })
          end
  ...
  describe '#text_search' do
    ...
    context 'when providing a search string' do
      ...
      it 'constructs a text search document' do
        expect(selection.selector_smash).to eq({ '$text' => { '$search' => 'testing' } })
      end
      ...
      context 'when providing text search options' do
        ...
        it 'constructs a text search document' do
          expect(selection.selector_smash['$text']['$search']).to eq('essais')
        end

        it 'add the options to the text search document' do
          expect(selection.selector_smash['$text'][:$language]).to eq('fr')
        end
  ...
  context 'when using multiple operators on the same field' do
    ...
    context 'when the same operator is specified' do
      ...
      it 'combines conditions' do
        ...
        # expect(selection.selector_smash).to eq('$and' => [{ 'field' => 5 }, { 'field' => 10 }])
        expect(selection.selector_smash).to eq('field' => 5, '$and' => [{ 'field' => 10 }])
      end
    end
