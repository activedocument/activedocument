...
describe ActiveDocument::Criteria::Queryable::Extensions::Numeric::ClassMethods do

  let(:host) do
    Class.new do
      include ActiveDocument::Criteria::Queryable::Extensions::Numeric::ClassMethods
    end.new
  end
