  ...
  [:store, :[]=].each do |method|
    ...
    describe "##{method}" do
      ...
      context 'when no serializers are provided' do
        ...
        context 'when providing a ActiveDocument::RawValue' do

          context 'and raw_value is a string' do

            before do
              selector.send(method, 'key', ActiveDocument::RawValue('Foo'))
            end
          ...
          context 'and raw_value cannot be converted by bson-ruby' do
            ...
            before do
              selector.send(method, 'key', ActiveDocument::RawValue(4..5))
            end
          ...
          context 'and raw_value is a complex type' do
            ...
            before do
              selector.send(method, 'key', ActiveDocument::RawValue([{ foo: 1, 'Bar' => [/baz/, BigDecimal('2'), 4..5] }, 3]))
            end
        ...
        context 'when the serializer is not localized' do
          ...
          context 'when the criterion is complex' do
            ...
            context 'when the field name is the key' do
              ...
              context 'when the criterion is a ActiveDocument::RawValue' do

                context 'and raw_value is a serializable string' do

                  before do
                    selector.send(method, 'key', ActiveDocument::RawValue('1'))
                  end
                ...
                context 'and raw_value is a serializable type' do
                  ...
                  before do
                    selector.send(method, 'key', ActiveDocument::RawValue(BigDecimal('2')))
                  end
