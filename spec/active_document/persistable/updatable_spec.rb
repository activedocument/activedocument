...
describe ActiveDocument::Persistable::Updatable do
  ...
  describe '#update_attribute' do
    ...
    context 'when the field is read-only' do
      ...
      it 'raises an error when trying to set the attribute' do
        ...
        end.to raise_exception(ActiveDocument::Errors::ReadonlyAttribute)
      end
    ...
    context 'when fields are explicitly not loaded' do
      ...
      context 'when the non-loaded attribute is updated' do
        ...
        it 'does not allow the field to be updated' do
          ...
          end.to raise_exception(ActiveDocument::Errors::AttributeNotLoaded, /Attempted to access attribute 'title' on Person which was not loaded/)
        end
  ...
  describe '#update!' do
    ...
    context 'when a callback aborts the callback chain' do
      ...
      it 'raises a callback error' do
        ...
        end.to raise_error(ActiveDocument::Errors::Callback)
      end
    end
  end
