...
describe ActiveDocument::Persistable::Settable do
  ...
  context 'when the field being set was projected out' do
    ...
    context 'field exists in database' do
      it 'raises AttributeNotLoaded' do
        expect do
          agent.set(title: '008')
        end.to raise_error(ActiveDocument::Errors::AttributeNotLoaded, /Attempted to access attribute 'title' on Agent which was not loaded/)
    ...
    context 'field does not exist in database' do
      it 'raises AttributeNotLoaded' do
        ...
        end.to raise_error(ActiveDocument::Errors::AttributeNotLoaded, /Attempted to access attribute 'number' on Agent which was not loaded/)
