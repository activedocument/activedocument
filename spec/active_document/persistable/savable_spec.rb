...
describe ActiveDocument::Persistable::Savable do
  extend ActiveDocument::ImmutableIds
    ...
    context 'when the changed attribute is not writable' do
      ...
      it 'raises an error' do
        expect do
          ...
          person.save
        end.to raise_error(ActiveDocument::Errors::AttributeNotLoaded, /Attempted to access attribute 'username' on Person which was not loaded/)
      end
  ...
  describe 'save!' do
    ...
    context 'with a validation error' do
      ...
      it 'raises an error with multiple save attempts' do
        expect { service.save! }.to raise_error(ActiveDocument::Errors::Validations)
        expect { service.save! }.to raise_error(ActiveDocument::Errors::Validations)
      end
    end
    ...
    context 'when a callback aborts the callback chain' do
      ...
      it 'raises a callback error' do
        expect { oscar.save! }.to raise_error(ActiveDocument::Errors::Callback)
      end
    end
