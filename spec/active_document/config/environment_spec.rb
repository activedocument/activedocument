...
describe ActiveDocument::Config::Environment do
    ...
    context 'when no environment information is found' do
      ...
      it 'raises an error' do
        expect { described_class.env_name }.to raise_error(
          ActiveDocument::Errors::NoEnvironment
        )
      end
    end
  end
  ...
  describe '#load_yaml' do
    ...
    context 'when file found' do
      ...
      context 'when file is empty' do
        ...
        it { expect { subject }.to raise_error(ActiveDocument::Errors::EmptyConfigFile) }
      end

      context 'when file does not contain a YAML Hash object' do
        let(:file_contents) { '["this", "is", "an", "array"]' }

        it { expect { subject }.to raise_error(ActiveDocument::Errors::InvalidConfigFile) }
      end
