...
describe ActiveDocument::Tasks::Database do
  ...
  after(:all) do
    ActiveDocument.deregister_model(DatabaseSpec::Measurement)
    DatabaseSpec.send(:remove_const, :Measurement)
    ActiveDocument.deregister_model(DatabaseSpec::Comment)
    DatabaseSpec.send(:remove_const, :Comment)
    ActiveDocument.deregister_model(DatabaseSpec::Note)
