...
describe ActiveDocument do
  ...
  describe '.configure' do
    ...
    context 'when no block supplied' do
      ...
      it 'returns the config singleton' do
        expect(described_class.configure).to eq(ActiveDocument::Config)
      end
    end
  ...
  describe '.default_client' do
    ...
    it 'returns the default client' do
      expect(described_class.default_client).to eq(ActiveDocument::Clients.default)
    end
  end
  ...
  describe '.disconnect_clients' do
    ...
    let(:clients) do
      ActiveDocument::Clients.clients.values
    end
  ...
  describe '.client' do
    ...
    it 'returns the named client' do
      expect(described_class.client(:default)).to eq(ActiveDocument::Clients.default)
    end
  end
