...
module ActiveDocument
  ...
  class StringifiedSymbol
    ...
    class << self
      ...
      #   ActiveDocument::StringifiedSymbol.demongoize('hedgehog')
      #
      ...
      #   ActiveDocument::StringifiedSymbol.mongoize(:hedgehog)
      #
      ...
      #   ActiveDocument::StringifiedSymbol.evolve(:hedgehog)
      #
