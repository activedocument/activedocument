...
module ActiveDocument
  ...
  module Fields
    ...
    module ClassMethods
      ...
      # Run through all custom options stored in ActiveDocument::Fields.options and
      # execute the handler if the option is provided.
      #
      # @example
      #   ActiveDocument::Fields.option :custom do
      #     puts "called"
      #   end
      #
      #   field = ActiveDocument::Fields.new(:test, :custom => true)
