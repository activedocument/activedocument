...
require 'active_document/attributes/dynamic'
require 'active_document/attributes/embedded'
require 'active_document/attributes/nested'
require 'active_document/attributes/processing'
require 'active_document/attributes/projector'
require 'active_document/attributes/readonly'
...
module ActiveDocument
  ...
  module Attributes
    ...
    rescue ActiveDocument::Errors::AttributeNotLoaded
      false
    end
    ...
    def read_raw_attribute(name)
      ...
      if attribute_missing?(normalized)
        raise ActiveDocument::Errors::AttributeNotLoaded.new(self.class, name)
      end
    ...
    #       raise ActiveDocument::Errors::InvalidValue.new(field.type, value.class)
    #     end
    #   end
    # end
