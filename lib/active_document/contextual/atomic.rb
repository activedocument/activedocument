...
module ActiveDocument
  module Contextual
    ...
    # Mixin module included in ActiveDocument::Criteria which provides a
    ...
    # without loading each document into ActiveDocument's memory.
    module Atomic
      ...
      #   ActiveDocument::Contextual::Aggregable::Mongo#min, this method cannot be
      ...
      #
      # @note Because of the existence of
      #   ActiveDocument::Contextual::Aggregable::Mongo#max, this method cannot be
