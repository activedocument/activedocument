...
require 'active_document/contextual/aggregable/memory'
...
module ActiveDocument
  module Contextual
    ...
    # ActiveDocument::Contextual::Mongo.
    class Memory
      include Enumerable
      ...
      #
      # @return [ Array<ActiveDocument::Document> ] The docs to iterate.
      ...
      # @param [ Array<ActiveDocument::Document> ] docs The docs to update.
      ...
      #
      # @param [ ActiveDocument::Document ] doc The document to pluck from.
      # @param [ [ String | Symbol ]... ] *fields Field(s) to pluck.
      #
