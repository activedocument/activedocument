    ...
    class Mongo
      ...
      class DocumentsLoader
        ...
        def self.global_thread_pool_async_query_executor
          ...
          concurrency = ActiveDocument.global_executor_concurrency || 4
        ...
        # Returns suitable executor according to ActiveDocument config options.
        #
        ...
        def self.executor(name = ActiveDocument.async_query_executor)
          case name.to_sym
          when :immediate
            immediate_executor
        ...
        # @return [ ActiveDocument::Criteria ] Criteria that specifies which documents should
        ...
        # @param [ Class ] klass ActiveDocument model class to instantiate documents.
        #   All records obtained from the database will be converted to an
        #   instance of this class, if possible.
        # @param [ ActiveDocument::Criteria ] criteria Criteria that specifies which
        ...
        # them to ActiveDocument documents of `@klass` type.
        #
        ...
        #
        # @return [ Array<ActiveDocument::Document> ] Array of document loaded from
        #   the database.
        def execute
