...
require 'active_document/contextual/aggregable/none'
...
module ActiveDocument
  module Contextual
    ...
    # is consistent with ActiveDocument::Contextual::Mongo.
    class None
      include Enumerable
      ...
      #   context.first!
      #
      # @raise [ ActiveDocument::Errors::DocumentNotFound ] always raises.
      def first!
