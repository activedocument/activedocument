...
module ActiveDocument
  ...
  module Traversable
    ...
    #
    # @return [ ActiveDocument::Document | nil ] the parent document
    #
    # @api private
    def _parent
      @__parent || nil
    ...
    #
    # @param [ ActiveDocument::Document | nil ] document the document to set as
    #   the parent document.
    #
    # @returns [ ActiveDocument::Document ] The parent document.
    #
    # @api private
    ...
    module DiscriminatorAssignment
      ...
      def discriminator_key=(value)
        ...
        if value
          ...
          # and re-delegate to ActiveDocument.
          class << self
