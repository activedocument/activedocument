...
require 'active_document/config/defaults'
require 'active_document/config/environment'
require 'active_document/config/options'
require 'active_document/config/validators'
require 'active_document/config/introspection'
require 'active_document/config/encryption'

module ActiveDocument

  # This module defines all the configuration options for ActiveDocument, including
  ...
  module Config
    ...
    def_delegators ::ActiveDocument, :logger, :logger=
    ...
    # Defines the isolation level that ActiveDocument uses to store its internal
    # state.
    #
    # Valid values are:
    ...
    #
    # If set to `:fiber`, ActiveDocument will use fiber-local storage instead. This
    ...
    # Checks to see if the provided isolation level is something that ActiveDocument
    ...
    # When this flag is false (the default as of ActiveDocument 9.0), a document that
    ...
    #
    # As of ActiveDocument 9.0, the record will remember that it came from
    ...
    # if there are more than around 1000 embedded documents in the root
    ...
    # This is the traditional (and default) behavior in ActiveDocument 9 and earlier.
    #
    # Setting this flag to true will allow named scopes to unset the default
    # scope. This will be the default in ActiveDocument 10.
    #
    ...
    # Has ActiveDocument been configured? This is checking that at least a valid
    # client config exists.
    #
    # @example Is ActiveDocument configured?
    #   config.configured?
    #
    # @return [ true | false ] If ActiveDocument is configured.
    def configured?
      clients.key?(:default)
    end
    ...
    # defined in a ActiveDocument::Document.
    #
    ...
    # Register a model in the application with ActiveDocument.
    #
    ...
    # Deregister a model in the application with ActiveDocument.
    #
    ...
    #   ActiveDocument::Config.truncate!
    #
    ...
    def set_log_levels
      ActiveDocument.logger.level = ActiveDocument::Config.log_level unless defined?(::Rails)
      Mongo::Logger.logger.level = ActiveDocument.logger.level
    end
    ...
    # Mixin used to deprecate ActiveDocument configuration options.
