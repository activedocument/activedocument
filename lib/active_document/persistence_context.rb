...
module ActiveDocument
  ...
  class PersistenceContext
    ...
    #
    # @param [ ActiveDocument::Document | Class ] document the child document
    #
    ...
    def requested_storage_options
      slice = @options.slice(*ActiveDocument::Clients::Validators::Storage::VALID_OPTIONS)
      slice.any? ? slice : nil
    end
    ...
    class << self
      ...
      # @param [ Hash | ActiveDocument::PersistenceContext ] options_or_context The persistence
      #   options or a persistence context object.
      #
      # @return [ ActiveDocument::PersistenceContext ] The persistence context for the object.
