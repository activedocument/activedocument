...
module ActiveDocument
  module Fields
    ...
    # documents which ActiveDocument persists.
    class Standard
      extend Forwardable
      ...
      #
      # @param [ ActiveDocument::Document ] _document The document to add to.
      ...
      #
      # @param [ ActiveDocument::Document ] doc The document the field belongs to.
      #
      ...
      #
      # @param [ ActiveDocument::Document ] doc The doc being applied to.
      #
