...
module ActiveDocument
  module Fields
    ...
    class ForeignKey < Standard
      ...
      #
      # @param [ ActiveDocument::Document ] document The document to add to.
      ...
      def evolve(object)
        if object_id_field? || object.is_a?(Document)
          if association.polymorphic?
            ...
            ActiveDocument::TypeConverters::ForeignKey.to_query_cast(object)
          end
        else
      ...
      #
      # @param [ ActiveDocument::Document ] _doc The document.
      #
