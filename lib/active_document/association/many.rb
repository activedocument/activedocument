...
module ActiveDocument
  module Association
    ...
    class Many < Association::Proxy
      ...
      #
      # @return [ ActiveDocument::Document ] The newly created document.
      ...
      #  @param [ Class ] type The optional type of document to create.
      #
      # @return [ ActiveDocument::Document ] An existing document or newly created one.
      ...
      #
      # @return [ ActiveDocument::Document ] An existing document or newly instantiated one.
      ...
      #   @param [ Class ] type The optional subclass to build.
      #
      # @return [ ActiveDocument::Document ] A matching document or a new/created one.
