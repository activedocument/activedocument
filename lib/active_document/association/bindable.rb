...
module ActiveDocument
  module Association
    ...
    module Bindable
      ...
      #
      # @param [ ActiveDocument::Document ] base The base of the binding.
      # @param [ ActiveDocument::Document | Array<ActiveDocument::Document> ] target The target of the binding.
      ...
      #
      # @param [ ActiveDocument::Document ] doc The document getting bound.
      #
      ...
      #
      # @param [ ActiveDocument::Document ] doc The document to remove.
      ...
      #
      # @param [ ActiveDocument::Document ] keyed The document that stores the foreign key.
      ...
      #
      # @param [ ActiveDocument::Document ] typed The document that stores the type field.
      ...
      #
      # @param [ ActiveDocument::Document ] doc The base document.
      # @param [ ActiveDocument::Document ] inverse The inverse document.
      ...
      #
      # @param [ ActiveDocument::Document ] doc The document to bind.
      ...
      #
      # @param [ ActiveDocument::Document ] doc The document to unbind.
