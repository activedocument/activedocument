  ...
  module Association
    module Nested
      ...
      class Many
        ...
        #   many.build(person)
        #
        # @param [ ActiveDocument::Document ] parent The parent document of the association.
        ...
        #
        # @param [ ActiveDocument::Document ] parent The parent document.
        # @param [ ActiveDocument::Association::Proxy ] relation The association proxy.
        # @param [ ActiveDocument::Document ] doc The doc to destroy.
        ...
        #
        # @param [ ActiveDocument::Association::Proxy ] relation The association proxy.
        # @param [ ActiveDocument::Document ] doc The document to delete.
        ...
        #
        # @param [ ActiveDocument::Document ] doc The document to update.
