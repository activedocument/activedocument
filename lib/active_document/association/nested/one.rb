  ...
  module Association
    module Nested
      ...
      class One
        ...
        #
        # @param [ ActiveDocument::Document ] parent The parent document.
        #
        # @return [ ActiveDocument::Document ] The built document.
        def build(parent)
        ...
        #
        # @param [ String | ActiveDocument::Document | nil ] name_or_class the value to coerce
        #
        # @return [ ActiveDocument::Document ] the resulting class
        ...
        #
        # If ActiveDocument::Config.immutable_ids is false, this will do nothing,
        ...
        def check_for_id_violation!
          ...
          # persisted document.
          raise Errors::ImmutableAttribute.new(:_id, id) if ActiveDocument::Config.immutable_ids

          ActiveDocument::Warnings.warn_mutable_ids
        end
      end
    end
  end
