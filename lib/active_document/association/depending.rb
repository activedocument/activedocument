  ...
  module Association
    ...
    module Depending
      ...
      class_methods do
        ...
        #
        # @return [ Array<ActiveDocument::Association::Relatable> ] The dependent
      ...
      #   ActiveDocument::Association::Depending.define_dependency!(association)
      #
      ...
      #
      # @param [ ActiveDocument::Association::Relatable ] association
      #   The association to validate.
      #
      # @raises [ ActiveDocument::Errors::InvalidDependentStrategy ]
      #   Error if invalid.
