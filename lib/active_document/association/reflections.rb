...
module ActiveDocument
  module Association
    ...
    module Reflections
      ...
      #
      # @return [ ActiveDocument::Association::Relatable ] The matching association metadata.
      ...
      #
      # @return [ Array<ActiveDocument::Association::Relatable> ] The matching association metadata.
