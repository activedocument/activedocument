  ...
  module Association
    module Referenced
      class BelongsTo
        ...
        # This class inherits from ActiveDocument::Association::Proxy and
        ...
        class Proxy < Association::One
          ...
          #   association.
          # @param [ ActiveDocument::Association::Relatable ] association The association object.
          ...
          #
          # @param [ ActiveDocument::Document | Array<ActiveDocument::Document> ] replacement The replacement.
          #
          ...
          #   proxy.normalize(id)
          #
          # @param [ ActiveDocument::Document | Object ] replacement The replacement object.
          #
          ...
          class << self
            ...
            #
            # @param [ ActiveDocument::Association::Relatable ] association The association object.
            # @param [ Array<ActiveDocument::Document> ] docs The array of documents.
            #
            # @return [ ActiveDocument::Association::Referenced::BelongsTo::Eager ]
            #   The eager loader.
