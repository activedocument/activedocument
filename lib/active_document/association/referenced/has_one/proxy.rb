  ...
  module Association
    module Referenced
      class HasOne
        ...
        # inherits from ActiveDocument::Association::Proxy and forwards most of
        ...
        class Proxy < Association::One
          ...
          module ClassMethods
            ...
            #
            # @return [ ActiveDocument::Association::Referenced::HasOne::Eager ]
            #   The eager loader.
          ...
          # @param [ ActiveDocument::Document ] target The target (child) of the association.
