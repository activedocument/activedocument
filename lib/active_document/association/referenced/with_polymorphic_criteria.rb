  ...
  module Association
    module Referenced
      ...
      module WithPolymorphicCriteria
        ...
        #
        # @param [ ActiveDocument::Criteria ] criteria the criteria to append to
        #   if receiver is polymorphic.
        # @param [ ActiveDocument::Document ] base the document to use when resolving
        #   the polymorphic type keys.
        #
        # @return [ ActiveDocument::Criteria] the resulting criteria, which may be
