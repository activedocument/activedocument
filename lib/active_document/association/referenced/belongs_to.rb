...
require 'active_document/association/referenced/belongs_to/binding'
require 'active_document/association/referenced/belongs_to/buildable'
require 'active_document/association/referenced/belongs_to/proxy'
require 'active_document/association/referenced/belongs_to/eager'
  ...
  module Association
    module Referenced
      ...
      class BelongsTo
        ...
        #   identifier.
        #
        # @return [ nil | ActiveDocument::ModelResolver ] the resolver to use
        def resolver
          @resolver ||= ActiveDocument::ModelResolver.resolver(@options[:polymorphic])
        end
