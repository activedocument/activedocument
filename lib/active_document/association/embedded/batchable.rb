  ...
  module Association
    module Embedded
      ...
      module Batchable
        ...
        #
        # @param [ Array<ActiveDocument::Document> ] docs The docs to clear.
        #
        ...
        #
        # @param [ Array<ActiveDocument::Document> ] docs The docs to remove.
        ...
        #
        # @param [ Array<ActiveDocument::Document> | Array<Hash> ] docs The docs to replace with.
        #
        # @return [ Array<Hash> ] The inserts.
        ...
        #
        # @param [ Array<ActiveDocument::Document> ] docs The docs to persist.
        #
        # @return [ Array<Hash> ] The inserts.
        ...
        #
        # @param [ Array<ActiveDocument::Document> | Array<Hash> ] docs The docs to normalize.
        #
        # @return [ Array<ActiveDocument::Document> ] The docs.
        ...
        def path
          @path ||= if _unscoped.empty?
                      ActiveDocument::Atomic::Paths::Embedded::Many.position_without_document(_base, _association)
                    else
        ...
        #
        # @param [ Array<ActiveDocument::Document> ] docs The inserted docs.
        #
