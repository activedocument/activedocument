    ...
    module Embedded
      class EmbedsOne
        ...
        class Proxy < Association::One
          ...
          # @param [ ActiveDocument::Document ] target The child document in the association.
          ...
          #
          # @param replacement [ ActiveDocument::Document | nil ] The doc to use to update the
          #   attributes hash.
          #
          # @api private
          ...
          #
          # @param [ ActiveDocument::Document ] replacement The replacement document.
          def update_target_when_not_assigning(replacement)
            ...
            # palette's new_record is false, ActiveDocument ends up "updating" the
          ...
          # document with nil.
          #
          # @param [ ActiveDocument::Document | Hash | nil ] replacement The document
          #   to check.
          #
          ...
          #
          # @param [ ActiveDocument::Document | Hash ] replacement The document to
          ...
          class << self
            ...
            #
            # @return [ ActiveDocument::Atomic::Paths::Embedded::One ]
            #   The embedded one atomic path calculator.
            def path(document)
              ActiveDocument::Atomic::Paths::Embedded::One.new(document)
            end
          end
        end
      end
