...
require 'active_document/association/embedded/embeds_many/binding'
require 'active_document/association/embedded/embeds_many/buildable'
require 'active_document/association/embedded/embeds_many/proxy'
  ...
  module Association
    module Embedded
      ...
      class EmbedsMany
        ...
        #
        # @return [ ActiveDocument::Atomic::Paths::Embedded::Many ]
        #   The embedded many atomic path calculator.
        def path(document)
          ActiveDocument::Atomic::Paths::Embedded::Many.new(document)
        end

        # Get a criteria object for searching given a parent and children documents.
        #
        # @param [ ActiveDocument::Document ] base The base document.
        # @param [ ActiveDocument::Document ] target The children documents.
