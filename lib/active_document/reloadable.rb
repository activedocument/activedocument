...
module ActiveDocument
  ...
  module Reloadable
    ...
    #
    # @return [ ActiveDocument::Document ] The document, reloaded.
    def reload
      reloaded = _reload
    ...
    #
    # If ActiveDocument.raise_not_found_error is false, this will do nothing.
    #
    ...
    def check_for_deleted_document!(attributes)
      return unless ActiveDocument.raise_not_found_error
    ...
    def reload_embedded_document
      ActiveDocument::Attributes::Embedded.traverse(
