...
module ActiveDocument
  module Persistable
    ...
    module Updatable
      ...
      #
      # @param [ Hash ] options The options.
      # @param [ Array<ActiveDocument::Document> ] children The children that the :update
      ...
      #
      # Note that if `ActiveDocument::Config.immutable_ids` is false, this will do
      # nothing.
      #
      ...
      def enforce_immutability_of_id_field!
        ...
        raise Errors::ImmutableAttribute.new(:_id, _id) if ActiveDocument::Config.immutable_ids
