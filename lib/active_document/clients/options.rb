...
module ActiveDocument
  module Clients
    ...
    # Mixin module included into ActiveDocument::Document which gives
    ...
    module Options
      ...
      #   end
      #
      # @param [ Hash | ActiveDocument::PersistenceContext ] options_or_context
      ...
      #
      # @return [ ActiveDocument::PersistenceContext ] The current persistence
      #   context.
      ...
      module ClassMethods
        ...
        #
        # @return [ ActiveDocument::PersistenceContent ] The current persistence
        #   context.
        def persistence_context
