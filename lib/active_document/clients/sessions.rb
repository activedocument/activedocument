  ...
  module Clients
    ...
    module Sessions
      ...
      module ClassMethods
        ...
        # except for the `ActiveDocument::Errors::Rollback`. This error is not passed on,
        ...
        #
        # @raise [ ActiveDocument::Errors::InvalidTransactionNesting ] If the transaction is
        #   opened on a client that already has an open transaction.
        # @raise [ ActiveDocument::Errors::TransactionsNotSupported ] If MongoDB deployment
        #   the client is connected to does not support transactions.
        # @raise [ ActiveDocument::Errors::TransactionError ] If there is an error raised
        ...
        # exception.
        #
        # This method ensures that ActiveDocument continues to work with older driver
