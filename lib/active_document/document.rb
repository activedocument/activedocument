...
module ActiveDocument
  ...
  module Document
    ...
    include Composable
    include ActiveDocument::Touchable::InstanceMethods
    ...
    #
    # @raise [ ArgumentError ] If the class doesn't include ActiveDocument::Document
    #
    ...
    # Checks that the given argument is an instance of `ActiveDocument::Document`.
    #
