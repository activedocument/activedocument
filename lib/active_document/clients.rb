...
require 'active_document/clients/factory'

module ActiveDocument
  # Singleton module with methods related to managing database clients.
  module Clients
    extend self
    ...
    #   ActiveDocument::Clients.default
    #
    ...
    #   ActiveDocument::Clients.disconnect
    #
    # @return [ true ] True.
    def disconnect
    ...
    #   ActiveDocument::Clients.reconnect
    #
    # @return [ true ] True.
    def reconnect
    ...
    #   ActiveDocument::Clients.with_name(:replica)
    #
    ...
    def with_name(name)
      ...
      CREATE_LOCK.synchronize do
        if (key_vault_client = ActiveDocument.clients.dig(name_as_symbol, :options, :auto_encryption_options, :key_vault_client))
    ...
    #   ActiveDocument::Clients.set(:analytics, my_client)
    #
