...
module ActiveDocument
  ...
  # Defines how ActiveDocument can autoload all defined models.
  module Loadable
    ...
    #   ActiveDocument.load_models(%w( ./models ./admin/models ))
    #
    ...
    #   ActiveDocument.load_model("/active_document/behavior")
    #
