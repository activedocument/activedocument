...
require 'active_document/atomic/modifiers'
require 'active_document/atomic/paths'
...
module ActiveDocument
  ...
  module Atomic
    ...
    included do
      ...
      # get rid of all indexing related code in ActiveDocument.
    ...
    #
    # @param [ ActiveDocument::Document ] document The embedded document to pull.
    ...
    #
    # @param [ ActiveDocument::Document ] document The child document.
    #
    ...
    # @param [ ActiveDocument::Document ] doc The document to update for.
