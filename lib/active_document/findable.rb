...
module ActiveDocument
  ...
  module Findable
    ...
    # +raise_not_found_error+ ActiveDocument configuration option is truthy
    ...
    # value of the document to find. ActiveDocument then attempts to retrieve all
    ...
    # If the +raise_not_found_error+ ActiveDocument configuration option is truthy,
    ...
    # ActiveDocument configuration option is falsy, only those documents which are
    ...
    #
    # The argument undergoes customary ActiveDocument type conversions based on
    ...
    # ActiveDocument.raise_not_found_error is true it raises
    # ActiveDocument::Errors::DocumentNotFound, return null nil elsewise.
    #
    ...
    # ActiveDocument::Errors::DocumentNotFound
    #
    # @example Find the document by attribute other than id
    #   Person.find_by(:username => "superuser")
    #
