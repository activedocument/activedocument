...
module ActiveDocument
  module Validatable
    ...
    class AssociatedValidator < ActiveModel::Validator
      ...
      #
      # @param [ ActiveDocument::Document ] document the document with the
      ...
      #
      # @param [ Array | ActiveDocument::Document | ActiveDocument::Association::Proxy | HasMany::Enumerable ] target
      #   the target object to examine.
      #
      # @return [ Array<ActiveDocument::Document> ] the list of documents
      ...
      #
      # @return [ Array<ActiveDocument::Document> ] the in-memory documents
      #   held by the target.
      ...
      #
      # @param [ Array | ActiveDocument::Document | ActiveDocument::Association::Proxy ] target
      #   the target to return.
      #
      # @return [ Array<ActiveDocument::Document> ] the target, as an array.
