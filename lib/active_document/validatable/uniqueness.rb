...
module ActiveDocument
  module Validatable
    ...
    class UniquenessValidator < ActiveModel::EachValidator
      ...
      # @param [ Object ] value The value of the object.
      #
      # @return [ ActiveDocument::Criteria ] The uniqueness criteria.
      ...
      #
      # @param [ ActiveDocument::Criteria ] criteria The criteria to scope.
      # @param [ ActiveDocument::Document ] document The document being validated.
      #
      # @return [ ActiveDocument::Criteria ] The scoped criteria.
      ...
      #
      # @param [ ActiveDocument::Document ] document The embedded document.
      #
      ...
      #
      # @param [ ActiveDocument::Document ] document The doc getting validated.
      ...
      #
      # @param [ ActiveDocument::Document ] document The document getting validated.
