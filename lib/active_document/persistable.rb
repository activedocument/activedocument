...
require 'active_document/persistable/creatable'
require 'active_document/persistable/deletable'
require 'active_document/persistable/destroyable'
require 'active_document/persistable/incrementable'
require 'active_document/persistable/logical'
require 'active_document/persistable/maxable'
require 'active_document/persistable/minable'
require 'active_document/persistable/multipliable'
require 'active_document/persistable/poppable'
require 'active_document/persistable/pullable'
require 'active_document/persistable/pushable'
require 'active_document/persistable/renamable'
require 'active_document/persistable/savable'
require 'active_document/persistable/settable'
require 'active_document/persistable/updatable'
require 'active_document/persistable/upsertable'
require 'active_document/persistable/unsettable'
...
module ActiveDocument
  ...
  module Persistable
    ...
    def atomically(join_context: nil)
      join_context = ActiveDocument.join_contexts if join_context.nil?
      call_depth = @atomic_depth ||= 0
      has_own_context = call_depth.zero? || !join_context
      @atomic_updates_to_execute_stack ||= []
      _active_document_push_atomic_context if has_own_context
      ...
      if has_own_context
        ...
        _active_document_remove_atomic_context_changes
      end

      true
    rescue StandardError => e
      _active_document_reset_atomic_context_changes! if has_own_context
      raise e
    ensure
      _active_document_pop_atomic_context if has_own_context
    ...
    def prepare_atomic_operation
      raise Errors::ReadonlyDocument.new(self.class) if readonly? && !ActiveDocument.legacy_readonly
    ...
    #   document._active_document_remove_atomic_context_changes
    def _active_document_remove_atomic_context_changes
      return unless executing_atomically?

      _active_document_atomic_context_changed_fields.each { |f| remove_change f }
    end
    ...
    #   document._active_document_reset_atomic_context_changes!
    def _active_document_reset_atomic_context_changes!
      return unless executing_atomically?

      _active_document_atomic_context_changed_fields.each { |f| reset_attribute! f }
    end
    ...
    #   document._active_document_push_atomic_context
    def _active_document_push_atomic_context
      return unless executing_atomically?
    ...
    #   document._active_document_pop_atomic_context
    def _active_document_pop_atomic_context
      return unless executing_atomically?
    ...
    #   document._active_document_atomic_context_changed_fields
    #
    # @return [ Array ] The changed fields.
    def _active_document_atomic_context_changed_fields
