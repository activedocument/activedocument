...
module ActiveDocument
  ...
  module Factory
    ...
    # @api private
    class Instantiator
      # @return [ ActiveDocument::Document ] The primary model class being referenced
      attr_reader :klass
      ...
      # @return [ ActiveDocument::Criteria | nil ] The criteria object to
      ...
      #
      # @param klass [ ActiveDocument::Document ] The primary class to reference when
      #   instantiating the model.
      # @param attributes [ Hash | nil ] (Optional) The hash of attributes to
      #   use when instantiating the model.
      # @param criteria [ ActiveDocument::Criteria | nil ] (Optional) The criteria
      ...
      #
      # @return [ ActiveDocument::Document ] The new document instance.
      ...
      # Instantiate the given `type`, which must map to another ActiveDocument::Document
      # model.
      #
      # @param [ true | false ] execute_callbacks Whether this method should
      #   invoke document callbacks.
      ...
      #
      # @return [ ActiveDocument::Document ] the requested Document model
    ...
    #   ActiveDocument::Factory.build(Person, { "name" => "Durran" })
    #
    ...
    #   should be run.
    #
    # @return [ ActiveDocument::Document ] The instantiated document.
    ...
    #
    # @example Build the document.
    #   ActiveDocument::Factory.from_db(Person, { "name" => "Durran" })
    #
    # @param [ Class ] klass The class to instantiate from if _type is not present.
    # @param [ Hash ] attributes The document attributes.
    # @param [ ActiveDocument::Criteria ] criteria Optional criteria object.
