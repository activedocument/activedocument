...
module ActiveDocument
  ...
  # This module contains all the callback hooks for ActiveDocument.
  module Interceptable
    ...
    included do
      ...
      # This callback is used internally by ActiveDocument to save association
    ...
    #   ActiveDocument has to get around it and implement itself.
    #
