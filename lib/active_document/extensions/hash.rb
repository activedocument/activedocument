  ...
  module Extensions
    ...
    module Hash
      ...
      def __consolidate__(klass)
        ActiveDocument::AtomicUpdatePreparer.prepare(self, klass)
      end
      ActiveDocument.deprecate(self, :__consolidate__)
      ...
      ActiveDocument.deprecate(self, :delete_id)
      ...
      ActiveDocument.deprecate(self, :extract_id)
