...
module ActiveDocument
  module Config
    ...
    module Encryption
      ...
      # @param [ Array<ActiveDocument::Document> ] models The models to generate the schema map for.
      #   Defaults to all models in the application.
      #
      # @return [ Hash ] The encryption schema map.
      def encryption_schema_map(default_database, models = ::ActiveDocument.models)
        visited = Set.new
      ...
      # The mapping of ActiveDocument field types to BSON type identifiers.
      TYPE_MAPPINGS = {
        Hash => 'object',
        Integer => 'int',
        BSON::Int32 => 'int',
        ...
        BSON::Binary => 'binData',
        Array => 'array',
        ActiveDocument::Boolean => 'bool',
        BigDecimal => 'decimal',
        Range => 'object',
        Regexp => 'regex',
        Set => 'array',
        ActiveDocument::StringifiedSymbol => 'string',
      ...
      #
      # @param [ ActiveDocument::Document ] model The model to generate the metadata for.
      #
      ...
      #
      # @param [ ActiveDocument::Document ] model The model to generate the properties for.
      # @param [ Set<ActiveDocument::Document> ] visited The set of models that have already been visited.
      #
      ...
      def properties_for_fields(model)
        model.fields.each_with_object({}) do |(name, field), props|
          next unless field.is_a?(ActiveDocument::Fields::Encrypted)
      ...
      #
      # @param [ ActiveDocument::Field ] field The field to get the BSON type identifier for.
      #
      ...
      #
      # @param [ ActiveDocument::Field ] field The field to get the algorithm for.
      #
