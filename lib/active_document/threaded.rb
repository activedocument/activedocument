...
module ActiveDocument
  ...
  module Threaded
    ...
    # Set the current ActiveDocument scope.
    #
    ...
    #   was modified.
    # @param [ ActiveDocument::Document ] document ActiveDocument document that was modified.
    ...
    #
    # @return [ Hash<Mongo::Session, Set<ActiveDocument::Document>> ] The modified
