...
module ActiveDocument
  ...
  # these methods may be moved into ActiveDocument::Contextual::Mongo as private
  # methods.
  #
  # @api private
  class AtomicUpdatePreparer
    class << self
      ...
      def mongoize_for(operator, klass, key, value)
        ...
        if ActiveDocument::Persistable::LIST_OPERATIONS.include?(operator) && field.resizable? && !value.is_a?(Array)
