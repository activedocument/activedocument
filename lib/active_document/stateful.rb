...
module ActiveDocument
  ...
  # Mixin module included into ActiveDocument::Document which adds behavior for
  ...
  module Stateful
    ...
    def readonly!
      if ActiveDocument.legacy_readonly
        ActiveDocument::Warnings.warn_legacy_readonly
        false
      else
        @readonly = true
      end
