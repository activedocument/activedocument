        ...
        module Date
          ...
          module ClassMethods
            ...
            def evolve(object)
              ...
              res.nil? ? ActiveDocument::RawValue(object, 'Date') : res
            end
          end
        end
      end
...
Date.include ActiveDocument::Criteria::Queryable::Extensions::Date
Date.extend ActiveDocument::Criteria::Queryable::Extensions::Date::ClassMethods
