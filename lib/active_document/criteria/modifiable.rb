...
module ActiveDocument
  class Criteria
    ...
    # Mixin module for ActiveDocument::Criteria which adds the ability
    ...
    module Modifiable
      ...
      #
      # @return [ ActiveDocument::Criteria ] A criteria.
      ...
      #
      # @return [ ActiveDocument::Document ] A matching or newly created document.
      ...
      # @param [ Hash ] attrs The attributes to check.
      #
      # @return [ ActiveDocument::Document ] A matching or newly initialized document.
      ...
      #
      # @return [ ActiveDocument::Document ] The first or new document.
      ...
      def invalid_key?(hash, key)
        ...
        key.to_s =~ ActiveDocument::Document::ILLEGAL_KEY || hash.key?(key.to_sym) || hash.key?(key)
      end
