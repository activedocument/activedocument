...
module ActiveDocument
  class Criteria
    ...
    # Mixin module included in ActiveDocument::Criteria which adds
    ...
    module Scopable
      ...
      #
      # @param [ Proc | Symbol | ActiveDocument::Criteria | nil ] scope The scope to apply.
      #
      # @return [ ActiveDocument::Criteria ] The criteria with the scope applied.
      #
      # @api private
      ...
      #
      # @param [ ActiveDocument::Criteria ] other The other criteria.
      #
