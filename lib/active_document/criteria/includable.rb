...
module ActiveDocument
  class Criteria
    ...
    module Includable
      ...
      #
      # @return [ Array<ActiveDocument::Association::Relatable> ] The inclusions.
      def inclusions
        @inclusions ||= []
      end
      ...
      #
      # @param [ Array<ActiveDocument::Association::Relatable> ] value The inclusions.
      #
      # @return [ Array<ActiveDocument::Association::Relatable> ] The new inclusions.
      ...
      #
      # @param [ Class | String | Symbol ] parent_class The class from which the
